...
/**
 * Test class to verify the {@link ProducerThrottlingBlockingQueue}. The tests are carried out using a {@link LinkedBlockingQueue}
 * as the backing queue.
 *
 * The private methods prefixed with "concurrent" are a bit verbose, but is so in order to get reliable results without sleeping. 
 * Instead the verification is performed using signaling with locks and barriers.
 * 
 */
public class ProducerThrottlingBlockingQueueTest
{
    ...
    public void shouldAddAllElements()
    {
        ...
        assertThat(queue).hasSize(calculateSizeWhenQueueHasMaxElementsFromAllProducers());
    }

    @Test
    public void shouldCopeWhenBackingQueueIsRejectingOfferOfElement()
    {
        BlockingQueue<Element> queue = new ProducerThrottlingBlockingQueue<Element>(new LinkedBlockingQueue<Element>(1));
    ...
    @Test
    public void shouldCopeWhenBackingQueueIsRejectingOfferOfElementUsingSpecifiedTimeout() throws Exception
    {
        BlockingQueue<Element> queue = new ProducerThrottlingBlockingQueue<Element>(new LinkedBlockingQueue<Element>(1));
        Element element = createDefaultElement();
    ...
    public void shouldOfferElementWithAttemptThrottleEvenThoughQueueShouldThrottle()
    {
        ...
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        Element attemptThrottleElement = new Element(DEFAULT_PRODUCER_IDENTIFIER, maximumProducerCapacity, ThrottlingPolicy.ATTEMPT_THROTTLE);
        Element mustThrottleElement = new Element(DEFAULT_PRODUCER_IDENTIFIER, maximumProducerCapacity, ThrottlingPolicy.MUST_THROTTLE);

        queue.offer(attemptThrottleElement);
        boolean attemptThrottleElementInserted = queue.offer(attemptThrottleElement);
    ...
    @Test
    public void shouldOfferElementWithSpecifiedTimeoutAndWithAttemptThrottleEvenThoughQueueShouldThrottle() throws Exception
    {
        int maximumProducerCapacity = 1;
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        Element attemptThrottleElement = new Element(DEFAULT_PRODUCER_IDENTIFIER, maximumProducerCapacity, ThrottlingPolicy.ATTEMPT_THROTTLE);
        ...
        boolean attemptThrottleElementInserted = queue.offer(attemptThrottleElement, 0, TimeUnit.SECONDS);
        boolean mustThrottleElementInserted = queue.offer(mustThrottleElement, 0, TimeUnit.SECONDS);
        ...
        mustThrottleElementInserted = queue.offer(mustThrottleElement, 0, TimeUnit.SECONDS);
    ...
    @Test
    public void shouldPutElementWithAttemptThrottleEvenThoughQueueShouldThrottle() throws Exception
    {
        int maximumProducerCapacity = 1;
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        Element attemptThrottleElement = new Element(DEFAULT_PRODUCER_IDENTIFIER, maximumProducerCapacity, ThrottlingPolicy.ATTEMPT_THROTTLE);
    ...
    @Test
    public void shouldAddElementWithAttemptThrottleEvenThoughQueueShouldThrottle() throws Exception
    {
        int maximumProducerCapacity = 1;
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        Element attemptThrottleElement = new Element(DEFAULT_PRODUCER_IDENTIFIER, maximumProducerCapacity, ThrottlingPolicy.ATTEMPT_THROTTLE);
        ...
        boolean attemptThrottleElementInserted = queue.add(attemptThrottleElement);
    ...
    @Test
    public void shouldSuccessfullyOfferAllElementsUsingASpecifiedTimeout() throws InterruptedException
    {
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();

        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY, 10, TimeUnit.SECONDS);

        assertThat(queue).hasSize(calculateSizeWhenQueueHasMaxElementsFromAllProducers());
    }

    @Test
    public void shouldSuccessfullyPutAllElementsUsingASpecifiedTimeout() throws InterruptedException
    {
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
    ...
    @Test
    public void shouldNotOfferElementWhenViolatingProducerCapacityAndSpecifyingAZeroTimeout() throws InterruptedException
    {
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();

        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);

        boolean inserted = queue.offer(createDefaultElement(), 0, TimeUnit.SECONDS);
    ...
    public void shouldPollAllFromQueue()
    {
        ...
        assertThat(numberOfPolledElements).isEqualTo(calculateSizeWhenQueueHasMaxElementsFromAllProducers());
        assertThat(queue).isEmpty();
    }

    @Test
    public void shouldSuccessfullyPollAllUsingASpecifiedTimeout() throws InterruptedException
    {
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        int numberOfPolledElements = 0;
    ...
    @Test
    public void shouldBeAbleToOfferElementsWithASpecifiedTimeoutAfterQueueIsDepleted() throws Exception
    {
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY, 10, TimeUnit.SECONDS);
    ...
    @Test
    public void shouldBeAbleToPutElementsAfterQueueIsDepleted() throws Exception
    {
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        putAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
    ...
    @Test
    public void shouldBeAbleToAddElementsAfterQueueIsDepleted() throws Exception
    {
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndAddAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
    ...
    @Test
    public void shouldNotPollMoreElementsThanAllowedWhenUsingAZeroTimeout() throws InterruptedException
    {
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        int numberOfPolledElements = 0;
    ...
    public void shouldDrainQueue()
    {
        ...
        assertThat(queue).isEmpty();
        assertThat(anotherQueue).hasSize(calculateSizeWhenQueueHasMaxElementsFromAllProducers());
    }
    ...
    public void shouldThrowIllegalArgumentExceptionWhenBackingQueueAndDrainToQueueAreSame()
    {
        ...
        BlockingQueue<Element> queue = new ProducerThrottlingBlockingQueue<Element>(backingQueue);
    ...
    public void shouldThrowIllegalArgumentExceptionWhenBackingQueueAndDrainToQueueAreSameAndUsingMaxElements()
    {
        ...
        queue.drainTo(backingQueue, calculateSizeWhenQueueHasMaxElementsFromAllProducers());
    }
    ...
    public void shouldThrowIllegalArgumentExceptionWhenThisQueueAndDrainToQueueAreSameAndUsingMaxElements()
    {
        ...
        queue.drainTo(queue, calculateSizeWhenQueueHasMaxElementsFromAllProducers());
    }
    ...
    public void shouldIterateOverQueueElements()
    {
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        Set<Element> identityBasedSet = Collections.newSetFromMap(new IdentityHashMap<Element, Boolean>());
        ...
        assertThat(identityBasedSet).hasSize(calculateSizeWhenQueueHasMaxElementsFromAllProducers());
        assertThat(queue).hasSize(calculateSizeWhenQueueHasMaxElementsFromAllProducers());
        assertThat(numberOfIteratedElements).isEqualTo(calculateSizeWhenQueueHasMaxElementsFromAllProducers());
    }

    @Test (expectedExceptions = NoSuchElementException.class)
    public void shouldThrowNoSuchElementExceptionWhenAttemptingToInvokeNextOnIteratorFromAnEmptyQueue()
    {
        Iterator<Element> iterator = createDefaultProducerThrottlingBlockingQueue().iterator();
        iterator.next();
    }
    ...
    {
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        List<Element> createdElements = verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
    ...
    public void shouldCalculateRemainingCapacity()
    {
        ...
        assertThat(queue.remainingCapacity()).isEqualTo(Integer.MAX_VALUE - calculateSizeWhenQueueHasMaxElementsFromAllProducers());
    }
    ...
    public void shouldReturnCurrentSizeOfQueue()
    {
        ...
        int expectedSize = calculateSizeWhenQueueHasMaxElementsFromAllProducers() - numberOfInsertedElements;
    ...
    {
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        Iterator<Element> createdElements = verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY).iterator();
        ...
        assertThat(queue).isEmpty();
        assertThat(numberOfRemovals).isEqualTo(calculateSizeWhenQueueHasMaxElementsFromAllProducers());
    ...
    public void shouldNotRemoveNonExistingElement()
    {
        ...
        boolean removed = queue.remove(new Element("Dummy", PRODUCER_CAPACITY, ThrottlingPolicy.MUST_THROTTLE));
    ...
    public void shouldContainElement()
    {
        BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY / 2);
        Element element = new Element("Dummy", PRODUCER_CAPACITY, ThrottlingPolicy.MUST_THROTTLE);
        queue.add(element);
    ...
    @Test
    public void shouldCopeWithProducerCapacityGoesBeyondDefinedLimitDueToAttemptThrottle() throws Exception
    {
        ...
        Element attemptThrottleElement = new Element(DEFAULT_PRODUCER_IDENTIFIER, maxNumberOfAllowedElements, ThrottlingPolicy.ATTEMPT_THROTTLE);
        Element mustThrottleElement = new Element(DEFAULT_PRODUCER_IDENTIFIER, maxNumberOfAllowedElements, ThrottlingPolicy.MUST_THROTTLE);
            ...
            public void run()
            {
                try
                {
                    ...
                    while (testThread.getState() != State.TIMED_WAITING
                            && (System.nanoTime() - startTime) < TimeUnit.NANOSECONDS.toSeconds(2))
                    {
                        Thread.yield();
                    }
    ...
    @Test
    public void shouldOfferElementToFullQueueUntilQueueIsCleared() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
    ...
    @Test
    public void shouldOfferElementToFullQueueUntilQueueIsDrained() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldOfferElementToFullQueueUntilQueueIsDrainedUsingMaxElements() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldOfferElementToFullQueueUntilAnotherElementIsRemoved() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        final Element firstElement = verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY).iterator().next();
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
        {
            @Override
            public void apply()
    ...
    @Test
    public void shouldOfferElementToFullQueueUntilAnotherElementIsRemovedUsingIterator() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldOfferElementToFullQueueUntilAnotherElementIsPolled() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldOfferElementToFullQueueUntilAnotherElementIsPolledUsingSpecifiedTimeout() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldOfferElementToFullQueueUntilAnotherElementIsTaken() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldPutElementToFullQueueUntilQueueIsCleared() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldPutElementToFullQueueUntilQueueIsDrained() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldPutElementToFullQueueUntilQueueIsDrainedUsingMaxElements() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldPutElementToFullQueueUntilAnotherElementIsRemoved() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        final Element firstElement = verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY).iterator().next();
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldPutElementToFullQueueUntilAnotherElementIsRemovedUsingIterator() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldPutElementToFullQueueUntilAnotherElementIsPolled() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldPutElementToFullQueueUntilAnotherElementIsPolledUsingSpecifiedTimeout() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldPutElementToFullQueueUntilAnotherElementIsTaken() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        verifyAndOfferAllElementsFromAllProducers(queue, PRODUCER_CAPACITY);
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldPollElementFromEmptyQueueUntilElementIsOffered() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
    ...
    @Test
    public void shouldPollElementFromEmptyQueueUntilElementIsOfferedUsingSpecifiedTimeout() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        final Element elementToAdd = createDefaultElement();
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldPollElementFromEmptyQueueUntilElementIsPut() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        final Element elementToAdd = createDefaultElement();
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldPollElementFromEmptyQueueUntilElementIsAdded() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        final Element elementToAdd = createDefaultElement();
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldTakeElementFromEmptyQueueUntilElementIsOffered() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        final Element elementToAdd = createDefaultElement();
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldTakeElementFromEmptyQueueUntilElementIsOfferedUsingSpecifiedTimeout() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        final Element elementToAdd = createDefaultElement();
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldTakeElementFromEmptyQueueUntilElementIsPut() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        final Element elementToAdd = createDefaultElement();
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
    ...
    @Test
    public void shouldTakeElementFromEmptyQueueUntilElementIsAdded() throws Exception
    {
        final BlockingQueue<Element> queue = createDefaultProducerThrottlingBlockingQueue();
        final Element elementToAdd = createDefaultElement();
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
        ...
        myExecutor.execute(new Runnable()
        {
            ...
            public void run()
            {
                try
                {
                    concurrentThread.set(Thread.currentThread());
                    reachedLockBarrier.countDown();
                    boolean isInserted = queue.offer(createDefaultElement(), 30, TimeUnit.SECONDS);
    ...
    private List<Element> verifyAndAddAllElementsFromAllProducers(BlockingQueue<Element> queue, int numberOfElements)
    {
        List<Element> createdElements = new ArrayList<Element>();
        createdElements.addAll(verifyAndAddAllElements(queue, numberOfElements, PRODUCER_IDENTIFIER_1));
        createdElements.addAll(verifyAndAddAllElements(queue, numberOfElements, PRODUCER_IDENTIFIER_2));
        createdElements.addAll(verifyAndAddAllElements(queue, numberOfElements, PRODUCER_IDENTIFIER_3));
        return createdElements;
    }

    private List<Element> verifyAndAddAllElements(BlockingQueue<Element> queue, int numberOfElements, Object producerIdentifier)
    {
        List<Element> createdElements = createElements(numberOfElements, producerIdentifier);
    ...
    private List<Element> verifyAndOfferAllElementsFromAllProducers(BlockingQueue<Element> queue, int numberOfElements)
    {
        List<Element> createdElements = new ArrayList<Element>();
        createdElements.addAll(verifyAndOfferAllElements(queue, numberOfElements, PRODUCER_IDENTIFIER_1));
        createdElements.addAll(verifyAndOfferAllElements(queue, numberOfElements, PRODUCER_IDENTIFIER_2));
        createdElements.addAll(verifyAndOfferAllElements(queue, numberOfElements, PRODUCER_IDENTIFIER_3));
        return createdElements;
    }

    private List<Element> verifyAndOfferAllElements(BlockingQueue<Element> queue, int numberOfElements, Object producerIdentifier)
    {
        List<Element> createdElements = createElements(numberOfElements, producerIdentifier);
    ...
    private List<Element> verifyAndOfferAllElementsFromAllProducers(BlockingQueue<Element> queue, int numberOfElements, long timeout, TimeUnit unit) throws InterruptedException
    {
        List<Element> createdElements = new ArrayList<Element>();
        createdElements.addAll(verifyAndOfferAllElements(queue, numberOfElements, PRODUCER_IDENTIFIER_1, timeout, unit));
        createdElements.addAll(verifyAndOfferAllElements(queue, numberOfElements, PRODUCER_IDENTIFIER_2, timeout, unit));
        createdElements.addAll(verifyAndOfferAllElements(queue, numberOfElements, PRODUCER_IDENTIFIER_3, timeout, unit));
        return createdElements;
    }

    private List<Element> verifyAndOfferAllElements(BlockingQueue<Element> queue, int numberOfElements, Object producerIdentifier, long timeout, TimeUnit unit) throws InterruptedException
    {
        List<Element> createdElements = createElements(numberOfElements, producerIdentifier);
    ...
    private List<Element> putAllElementsFromAllProducers(BlockingQueue<Element> queue, int numberOfElements) throws InterruptedException
    {
        List<Element> createdElements = new ArrayList<Element>();
        createdElements.addAll(putAllElements(queue, numberOfElements, PRODUCER_IDENTIFIER_1));
        createdElements.addAll(putAllElements(queue, numberOfElements, PRODUCER_IDENTIFIER_2));
        createdElements.addAll(putAllElements(queue, numberOfElements, PRODUCER_IDENTIFIER_3));
        return createdElements;
    }

    private List<Element> putAllElements(BlockingQueue<Element> queue, int numberOfElements, Object producerIdentifier) throws InterruptedException
    {
        List<Element> createdElements = createElements(numberOfElements, producerIdentifier);
    ...
    private List<Element> createElements(int numberOfElements, Object producerIdentifier)
    {
        List<Element> createdElements = new ArrayList<Element>(numberOfElements);

        for (int i = 0; i < numberOfElements; ++i)
        {
            createdElements.add(new Element(producerIdentifier, PRODUCER_CAPACITY, ThrottlingPolicy.MUST_THROTTLE));
        }
    ...
    {
        return new Element(DEFAULT_PRODUCER_IDENTIFIER, PRODUCER_CAPACITY, ThrottlingPolicy.MUST_THROTTLE);
    }

    private BlockingQueue<Element> createDefaultProducerThrottlingBlockingQueue()
    {
        return new ProducerThrottlingBlockingQueue<Element>(new LinkedBlockingQueue<Element>());
    }
    ...
    private static class Element implements ProducerThrottlingQueueElement
    {
        ...
        Element(Object producerIdentifier, int producerCapacity, ThrottlingPolicy throttlingPolicy)
        {
