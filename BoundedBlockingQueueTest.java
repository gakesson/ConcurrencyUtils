...
/**
 * Test class to verify the {@link BoundedBlockingQueue}. The tests are carried out using a {@link PriorityQueue}
 * as the backin queue.
 *
...
public class BoundedBlockingQueueTest
{
    ...
    public void shouldThrowIllegalStateExceptionWhenAttemptingToUsingIteratorFromAnEmptyQueue(Comparator<Element> comparator)
    {
        ...
        Iterator<Element> iterator = new BoundedBlockingQueue<Element>(numberOfElements, createQueueToWrap()).iterator();
        iterator.remove();
    }
    ...
    {
        int numberOfElements = 1;
        Iterator<Element> iterator = new BoundedBlockingQueue<Element>(numberOfElements, createQueueToWrap(comparator)).iterator();
        iterator.next();
    }
    ...
    public void shouldCreatePriorityBlockingQueueUsingAnotherCollection(Comparator<Element> comparator)
    {
        ...
        BlockingQueue<Element> queue = new BoundedBlockingQueue<Element>(capacity,new PriorityQueue<Element>(anotherQueue), false);
    ...
    public void shouldCreatePriorityBlockingQueueWithSpecifiedCapacity()
    {
        ...
        BlockingQueue<Element> queue = new BoundedBlockingQueue<Element>(capacity, createQueueToWrap());
    ...
    {
        new BoundedBlockingQueue<Element>(0, createQueueToWrap(comparator));
    }
    
    @Test (expectedExceptions = IllegalArgumentException.class)
    public void shouldThrowIllegalArgumentExceptionWhenBackingQueueSizeIsGreaterThanCapacity()
    {
    	Queue<Element> queue = createQueueToWrap();
    	queue.add(new Element());
    	queue.add(new Element());
        new BoundedBlockingQueue<Element>(1, queue);
    }

    @Test (expectedExceptions = IllegalArgumentException.class)
    public void shouldThrowIllegalArgumentExceptionWhenInvokingDrainToUsingSameQueue()
    {
        BlockingQueue<Element> queue = new BoundedBlockingQueue<Element>(1, createQueueToWrap());
        queue.drainTo(queue);
    }
    ...
    public void shouldAddAllElements(Comparator<Element> comparator)
    {
        ...
        BlockingQueue<Element> queue = new BoundedBlockingQueue<Element>(numberOfElements, createQueueToWrap(comparator));
    ...
    {
        BlockingQueue<Element> queue = new BoundedBlockingQueue<Element>(1, createQueueToWrap(comparator));
        queue.add(null);
    }
    ...
    public void shouldNotOfferAllElementsWhenViolatingCapacityAndSpecifyingAZeroTimeout(Comparator<Element> comparator) throws InterruptedException
    {
        ...
        BlockingQueue<Element> queue = new BoundedBlockingQueue<Element>(capacity, createQueueToWrap(comparator));
    ...
    public void shouldDrainQueue(Comparator<Element> comparator)
    {
        ...
        BlockingQueue<Element> queue = new BoundedBlockingQueue<Element>(numberOfElements, createQueueToWrap(comparator));
        verifyAndOfferAllElements(numberOfElements, queue);
        BlockingQueue<Element> anotherQueue = new BoundedBlockingQueue<Element>(numberOfElements, createQueueToWrap(comparator));
    ...
    {
        int numberOfElements = 200;
        BlockingQueue<Element> queue = new BoundedBlockingQueue<Element>(numberOfElements, createQueueToWrap());
    ...
    public void shouldKeepPrioritizonOrderWhenDrainingQueue(Comparator<Element> comparator) throws InterruptedException
    {
        ...
        BlockingQueue<Element> queue = new BoundedBlockingQueue<Element>(numberOfElements, createQueueToWrap(comparator));
        verifyAndOfferAllElements(numberOfElements, queue);
        BlockingQueue<Element> originalQueue = new BoundedBlockingQueue<Element>(numberOfElements, new PriorityQueue<Element>(queue), false);
    ...
    {
        int numberOfElements = 200;
        final BlockingQueue<Element> queue = new BoundedBlockingQueue<Element>(numberOfElements, createQueueToWrap(comparator));
        verifyAndOfferAllElements(numberOfElements, queue);
    ...
    public void shouldOfferElementToFullQueueUntilQueueIsDrained(final Comparator<Element> comparator) throws Exception
    {
        ...
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
        {
            ...
            public void apply()
            {
                queue.drainTo(new BoundedBlockingQueue<Element>(numberOfElements, createQueueToWrap(comparator)));
            }
        };
    ...
    public void shouldOfferElementToFullQueueUntilQueueIsDrainedUsingMaxElements(final Comparator<Element> comparator) throws Exception
    {
        ...
        ExecutionInjection executionToEnableSpace = new ExecutionInjection()
        {
            ...
            public void apply()
            {
                ...
                queue.drainTo(new BoundedBlockingQueue<Element>(numberOfElements, createQueueToWrap(comparator)), maxElements);
            }
        };
    ...
    public void shouldPollElementFromEmptyQueueUntilElementIsOffered(Comparator<Element> comparator) throws Exception
    {
        ...
        final BlockingQueue<Element> queue = new BoundedBlockingQueue<Element>(capacity, createQueueToWrap(comparator));
    ...
    /**
     * Creates a new {@link PriorityQueue} without a comparator.
     * 
     * @return
     */
    private PriorityQueue<Element> createQueueToWrap()
    {
    	return createQueueToWrap(null);
    }
    
    /**
     * Creates a new {@link PriorityQueue} with the provided comparator.
     * 
     * @param priorityQueueComparator
     * @return
     */
    private PriorityQueue<Element> createQueueToWrap(Comparator<Element> priorityQueueComparator)
    {
    	return new PriorityQueue<Element>(1, priorityQueueComparator);
    }
